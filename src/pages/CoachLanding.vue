    ...
    <div>
        <div class="page-header page-header-small clear-filter" filter-color="black">
            ...
            <div class="content-center">
                <div class="container">
                    <h1 class="title">Be an Inspiration.</h1>
                    <h3>Fire up your students with your fiery passion at Sporbius.</h3>
                    <div class="text-center">
                        <router-link class="btn btn-primary" to="/coachlogin">
                            <p class="m-0"><i class="ri-login-box-fill ri-lg"></i> Get Started</p>
                        </router-link>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8 ml-auto mr-auto text-center">
                        <h2 class="title">We bring students to you at Sporbius.</h2>
                        <h5>
                            Schedule your activities and availabilities at Sporbius where it can reach out to more
                            potential students than only the ones who can make it to certain days and timings!
                        </h5>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-md px-0">
                <div class="card text-bg-dark">
                    <img src="../../public/images/CoachLandingCard1.jpg" class="card-img">
                    <div class="card-img-overlay p-5">
                        <h1 class="title text-white">One-to-One Coaching</h1>
                    </div>
                </div>
            </div>
            <div class="col-md px-0">
                <div class="card text-bg-dark">
                    <img src="../../public/images/CoachLandingCard2.jpg" class="card-img">
                    <div class="card-img-overlay p-5">
                        <h1 class="title text-white">Connect with more students</h1>
                    </div>
                </div>
            </div>
            <div class="col-md-4 px-0">
                <div class="card text-bg-dark">
                    <img src="../../public/images/CoachLandingCard3.jpg" class="card-img">
                    <div class="card-img-overlay p-5">
                        <h1 class="title text-white">Brand your own profile</h1>
                    </div>
                </div>
            </div>
        </div>
        <div class="section section-about-us">
            <div class="container">
                <div class="row">
                    <div class="col-md-8 ml-auto mr-auto text-center">
                        <h2 class="title">Our Purpose to Coaches</h2>
                        <h5>To enable coaches to easily schedule and host their sessions for students to easily secure their places at the desired timeslot and venue. No more worrying to retaining students.</h5>
                    </div>
                </div>
                <div class="separator separator-primary"></div>
            </div>
        ...
        <div class="section section-about-us p-0">
            <div class="container">
                <div class="row">
                    <div class="col-md-8 ml-auto mr-auto text-center">
                        <h2 class="title">Simple and easy to use</h2>
                        <h5>Coming soon on IOS and Android</h5>
                        <img src="../../public/images/AppStoreGooglePlay.jpg" />
                    </div>
                </div>
                <div class="separator separator-primary"></div>
            </div>
                        ...
                        <div class="col-md-3">
                            <div class="team-player">
                                <img src="images/ReginaProfilePic.jpg" alt="Thumbnail Image"
                                    class="rounded-circle img-fluid img-raised" />
                                <h4 class="title">Regina Ang</h4>
                                <p class="category text-primary">CEO</p>
                                <h5>
                                    The vision of Sporbius is to build a healthy community in connecting coaches and
                                    potential students in
                                    common sport.
                                </h5>
                                <a href="https://www.instagram.com/reginangra/"
                                    class="btn btn-primary btn-icon btn-round" target="_blank"><i class="fab fa-instagram"></i></a>
                                <a href="https://www.linkedin.com/in/reginaang-ra"
                                    class="btn btn-primary btn-icon btn-round" target="_blank"><i class="fab fa-linkedin"></i></a>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="team-player">
                                <img src="images/DexterProfilePic.jpg" alt="Thumbnail Image"
                                    class="rounded-circle img-fluid img-raised" />
                                <h4 class="title">Dexter Chua</h4>
                                <p class="category text-primary">COO</p>
                                <h5>
        ...
        <div class="container">
          ...
          <div class="row">
            <div class="col-lg-6 text-center ml-auto mr-auto col-md-8">
              <fg-input class="input-lg" placeholder="First Name..." v-model="form.firstName"
                addon-left-icon="now-ui-icons users_circle-08">
              </fg-input>
              <fg-input class="input-lg" placeholder="Email Here..." v-model="form.email"
    ...
    <div>
      <div class="page-header clear-filter" filter-color="black">
        <parallax
          ...
          style="background-image:url('images/CoachLandingWallpaper.jpg')"
        >
        </parallax>
        <div class="container">
          <div class="content-center">
            <img class="n-logo" src="images/logo.png" style="width: 280px; margin-bottom: 40px;" alt="" />
            <h1 class="h1-seo">Be an inspiration.</h1>
            <h3>Fire up your students with your fiery passion at Sporbius.</h3>
            <router-link class="btn btn-primary" to="/coachlogin">
              <p class="m-0"><i class="ri-login-box-fill ri-lg"></i> Get Started</p>
            </router-link>
