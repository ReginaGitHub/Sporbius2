  ...
  <div v-if="role == 'coach'">
    ...
    <div class="section">
      <div class="container">
        ...
        <div v-if="aboutMe !== '' && aboutMe !== undefined && chosenSport.length !== 0">
          <h3 class="title">About me <div type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal"
              data-bs-target="#staticBackdropAboutMeID">
              <i class="ri-edit-box-line ri-lg"></i> Edit
            </div>
          </h3>
        ...
        <div v-else class="text-center m-5">
          <h5 class="my-4">Adding about me details helps students to get to know you better!</h5>
          <!-- Button trigger modal -->
          <div type="button" class="btn btn-primary btn-lg" data-bs-toggle="modal"
            data-bs-target="#staticBackdropAboutMeID">
            <i class="ri-add-line ri-lg"></i> Add about me details
          </div>
        </div>
        ...
        <div class="row">
          ...
          <tabs pills class="nav-align-center" tab-content-classes="gallery" tab-nav-classes="nav-pills-just-icons"
            type="primary">
            <tab-pane title="Profile">
              ...
              <div class="text-center mb-5">
                ...
                <!-- Button trigger modal -->
                <div type="button" class="btn btn-primary btn-lg" data-bs-toggle="modal"
                  data-bs-target="#staticBackdropTrainingDetailsID" v-on:click="clearTrainingDetails">
              ...
              <div class="row">
                <div class="col-md-4 text-center" v-for="(photo, idx) in photoGallery" v-bind:key="idx"
                  ...
                  <div class="mt-5" style="height: 240px">
                    <img v-bind:src="photo" class="img-raised" style="object-fit: cover; height:100%; " />
                  </div>
                  <!-- Button trigger modal -->
            ...
            <tab-pane title="Home">
              ...
              <div class="text-center mb-5" v-if="uploadedVideo == ''">
                ...
                <!-- Button trigger modal -->
                <div type="button" class="btn btn-primary btn-lg" data-bs-toggle="modal"
                  data-bs-target="#staticUploadVideoID">
                  <i class="ri-add-line ri-lg"></i> Upload Video
                </div>
              </div>
              <div v-else>
                <div class="text-center mb-5">
                  ...
                  <div type="button" class="btn btn-primary btn-lg" data-bs-toggle="modal"
                    data-bs-target="#staticUploadVideoID">
                    <i class="ri-edit-box-line ri-lg"></i> Edit Video
                  </div>
                </div>
                <div class="text-center">
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <h5 class="fs-6">You can write about your years of experience, industry, or skills. People also talk about
              their achievements or previous job experiences.</h5>
            <div class="form-floating">
              <textarea class="form-control" style="height: 150px;" maxlength="2600" id="AboutMeTextareaID"
                v-on:keyup="incrementordecrementCharacters">{{ aboutMe }}</textarea>
              <p class="text-muted float-end"><span id="currCharactersNum">{{ charactersLength }}</span>/2600
                characters</p>
            </div>
            <br>
    ...
    <div class="modal fade" id="staticBackdropTrainingDetailsID" data-bs-backdrop="static" data-bs-keyboard="false"
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <h1 class="modal-title fs-5 fw-bold" id="staticBackdroTrainingDetailsLabel">Add Training Details</h1>
          ...
          <div class="modal-body">
            ...
            <div class="form-floating">
              ...
              <h5 class="d-block form-label">
                <div class="d-inline"><input type="text" class="form-control" placeholder="Enter Address"
                    v-model="address" /></div>
              </h5>
              <h5 class="d-block form-label">
                <div class="d-inline"><input type="text" class="form-control" placeholder="Enter Postal Code"
                    v-model="postalCode" /></div>
              </h5>
              <h5 class="fw-bold mt-3">Training Details</h5>
              <div><textarea class="form-control" style="font-size:medium" placeholder="Enter Training Details"
                  v-model="trainingDesc"></textarea></div>
              ...
              <h5 class="fw-bold mt-3">End Time: <input type="time" class="form-control mt-3" v-model="endTimeInput" />
              </h5>
              <h5 class="fw-bold">Price</h5>
              <input type="number" class="form-control w-75 d-inline" style="font-size:medium" v-model="priceInput" />
    ...
    <div class="modal fade" id="staticBackdropEditTrainingDetailsID" data-bs-backdrop="static" data-bs-keyboard="false"
      tabindex="-1" aria-labelledby="staticBackdroEditTrainingDetailsLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <h1 class="modal-title fs-5 fw-bold" id="staticBackdroEditTrainingDetailsLabel">Add Training Details</h1>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
          </div>
          <div class="modal-body">
            <h5 class="fs-6">Fill in the training details that you will be hosting on that day!</h5>
          ...
          <div class="modal-footer">
            <button type="button" class="btn btn-primary mt-3 float-end" id="saveEditChangesID"
              ...
              Changes</button>
            <button type="button" class="btn btn-danger mt-3" id="saveEditChangesID" v-on:click="deleteTrainingDetails"
    ...
    <div class="modal fade" id="staticUploadVideoID" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
      aria-labelledby="staticUploadVideoLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
          ...
          <div class="modal-body">
            ...
            <h5 class="fs-6">Once your video has been approved by Sporbius, others will be able to see it. This will
              take up till 3 working days.</h5>
            <div class="form-floating">

              <div style="border: 3px dashed #007bff; cursor: pointer;" class="text-center" @click="$refs.file.click()">
          ...
          <div class="modal-footer">
            <button type="button" class="btn btn-primary mt-3 float-end" id="saveEditChangesID" v-on:click="saveVideo"
    ...
    <div class="modal fade" id="staticBackdropAddProfilePicAndCoverPageID" data-bs-backdrop="static"
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <h1 class="modal-title fs-5 fw-bold" id="staticBackdropAddProfilePicAndCoverPageLabel">Upload Profile
          ...
          <div class="modal-body">
            ...
            <div class="form-floating">
              ...
              <div style="border: 3px dashed #007bff; cursor: pointer;" class="text-center"
                ...
                <input id="profilePhotofile-inputID" type="file" class="profilePhotoFile-input" ref="profilephoto"
                  v-on:change="profilePhotoInputedChange($event)" hidden />
                <i class="ri-upload-cloud-2-fill ri-3x" style="color: #007bff"></i>
                <h4 style="color: #007bff" class="m-0 mb-3"> Browse File to Upload</h4>
              </div>
              ...
              <div style="border: 3px dashed #007bff; cursor: pointer;" class="text-center"
                ...
                <input id="coverPhotofile-inputID" type="file" class="coverPhotoFile-input" ref="coverphoto"
                  v-on:change="coverPhotoInputedChange($event)" hidden />
                <i class="ri-upload-cloud-2-fill ri-3x" style="color: #007bff"></i>
                <h4 style="color: #007bff" class="m-0 mb-3"> Browse File to Upload</h4>
              </div>
    ...
    <div class="modal fade" id="staticBackdropPhotoGalleryID" data-bs-backdrop="static" data-bs-keyboard="false"
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <h1 class="modal-title fs-5 fw-bold" id="staticBackdropPhotoGalleryLabel">Add Photo(s) to Gallery</h1>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
          </div>
          <div class="modal-body">
            ...
            <div class="form-floating">
              ...
              <div style="border: 3px dashed #007bff; cursor: pointer;" class="text-center"
                ...
                <input id="galleryPhotofile-inputID" type="file" class="galleryPhotoFile-input" ref="galleryphoto"
                  v-on:change="galleryPhotoInputedChange($event)" hidden />
                <i class="ri-upload-cloud-2-fill ri-3x" style="color: #007bff"></i>
                <h4 style="color: #007bff" class="m-0 mb-3"> Browse File to Upload</h4>
              </div>
